    ...
    <DetailsContainer>
      {
        postId !== null ?
          ...
          <>
            <p>
              Title: {isPostLoading ? 'loading...' : post.title}
            </p>
            <p>
              Description: {isPostLoading ? 'loading...' : post.description}
            </p>
            <p>
              Username: {isUserLoading ? 'loading...' : user?.name}
            </p>
            <p>
              Email: {isUserLoading ? 'loading...' : user?.email}
            </p>
